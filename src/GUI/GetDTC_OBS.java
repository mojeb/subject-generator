 ...
 * @author Rommel
 */
public class GetDTC_OBS extends javax.swing.JDialog {

    /**
     * Creates new form GetDTC_employee
     */
    private Methods m = new Methods();
    
    public GetDTC_OBS(javax.swing.JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(emp_id.isEmpty() || month.equals("Select Month") || year.equals("Year")){
            JOptionPane.showMessageDialog(this, "Error! Please complete the required information", 
                    "Error Message", JOptionPane.ERROR_MESSAGE);
        }else{
            DTC dtc = new DTC();
            Date date = new Date(Integer.parseInt(year)-1900,jComboBox1.getSelectedIndex()-1,1);
            PrintData_short print = new PrintData_short();
            print.setDTC(dtc);
            print.setDate(date);
            print.setEmp_id(emp_id);
...
//            java.util.logging.Logger.getLogger(GetDTC_employee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//
//            public void run() {
//                GetDTC_employee dialog = new GetDTC_employee(new javax.swing.JFrame(), true);
