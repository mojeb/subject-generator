 ...
 * @author mojeb
 */
public class ViewITList extends javax.swing.JDialog {

    /**
     * Creates new form ViewITList
     */
    ...
    public ViewITList(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        this.setTitle("View I.T. List");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("View Iterinary of Travel");
        ...
        jButton1.setToolTipText("View list");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(year.equalsIgnoreCase("Year") || month.equalsIgnoreCase("Select Month")){
            ...
            try{
                itList = itServ.getIT_date_app(date1, date2);
...
//            java.util.logging.Logger.getLogger(ViewITList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//
//            public void run() {
//                ViewITList dialog = new ViewITList(new javax.swing.JFrame(), true);
